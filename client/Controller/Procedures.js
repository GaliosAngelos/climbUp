// all database procedures for hall owners, encapsulated in an immutable object.
...
// Database procedures for climbers, encapsulated in an immutable object.
export const Climber = Object.freeze({
  ...
  insert_user_statistic: {
    ...
    values: [
      ...
      "difficulty",
      "nr_rests",
      "reached_top_TRUE_FALSE",
    ],
  },
  get_user_statistics: {
    call: `SELECT * from climbup.get_user_statistics4($1, $2)`,
